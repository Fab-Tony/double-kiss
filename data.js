...
window.DK = (function () {
  ...
  const teams = [
    ...
    { name: "Balls Deep", captain: "Fenn Warth", players: [
      { name: "Sev Gharedaghi", r: 473, wp: 48, gw: 30, gp: 63 },
      { name: "Elliot Osborne", r: 409, wp: 41, gw: 20, gp: 49 },
      { name: "Gian Romeo", r: 335, wp: 23, gw: 8, gp: 35 },
      { name: "Fenn Warth", r: 279, wp: 17, gw: 7, gp: 42, c: true },
    ] },

    { name: "Break & Enter", captain: "Nathan Wood", players: [
      { name: "Greg Jenkins", r: 698, wp: 64, gw: 27, gp: 42 },
      { name: "Rob Carnell", r: 539, wp: 59, gw: 33, gp: 56 },
      { name: "Rachel Lewis", r: 425, wp: 49, gw: 17, gp: 35 },
      { name: "Nathan Wood", r: 383, wp: 35, gw: 17, gp: 49, c: true },
    ] },

    { name: "Cue The Good Times", captain: "Mike Dogan", players: [
      { name: "Joe Chao", r: 705, wp: 81, gw: 34, gp: 42 },
      { name: "Alex Koussas", r: 590, wp: 69, gw: 24, gp: 35 },
      { name: "Philip Campbell", r: 502, wp: 43, gw: 18, gp: 42 },
      { name: "Wesley Valele", r: 490, wp: 36, gw: 10, gp: 28 },
      { name: "Mike Dogan", r: 432, wp: 43, gw: 18, gp: 42, c: true },
    ...
    { name: "Dragonball Z", captain: "Adam Wowk", players: [
      ...
      { name: "Maghmud Sadien", r: 500, wp: 57, gw: 28, gp: 49 },
      { name: "Shaun Matthews", r: 472, wp: 46, gw: 13, gp: 28 },
      { name: "Steven Tien", r: 434, wp: 38, gw: 16, gp: 42 },
      { name: "Adam Wowk", r: 419, wp: 31, gw: 13, gp: 42, c: true },
    ] },

    { name: "Extorting Dogs", captain: "Will Yuan", players: [
      { name: "Chris Dam", r: 680, wp: 57, gw: 16, gp: 28 },
      { name: "Adam Taylor", r: 627, wp: 64, gw: 18, gp: 28 },
      { name: "Sam Stacy", r: 627, wp: 57, gw: 32, gp: 56 },
      { name: "Will Yuan", r: 477, wp: 41, gw: 14, gp: 34, c: true },
      { name: "Liam Pratt", r: 454, wp: 36, gw: 10, gp: 28 },
      { name: "Ned Pulido", r: 401, wp: 24, gw: 5, gp: 21 },
    ] },

    { name: "Freeballers", captain: "Josh Leary", players: [
      { name: "Mark Harper", r: 559, wp: 54, gw: 30, gp: 56 },
      { name: "Josh Leary", r: 465, wp: 37, gw: 26, gp: 70, c: true },
      { name: "Gerard Crowe", r: 445, wp: 38, gw: 8, gp: 21 },
      { name: "Joshua Mackintosh", r: 421, wp: 27, gw: 17, gp: 63 },
    ] },
    ...
    { name: "Iron 4", captain: "Graz Ferreri", players: [
      { name: "Andrew Samarjia", r: 593 },
      { name: "Dinesh Sookgreep", r: 577, wp: 52, gw: 33, gp: 63 },
      { name: "Dai Leota", r: 575, wp: 65, gw: 41, gp: 63 },
      { name: "Graz Ferreri", r: 558, wp: 59, gw: 37, gp: 63, c: true },
    ] },

    { name: "Marvin's Crew", captain: "Shaun Oglesby", players: [
      { name: "Shaun Oglesby", r: 667, wp: 70, gw: 44, gp: 63, c: true },
      { name: "Mitchell Tucker", r: 617, wp: 43, gw: 3, gp: 7 },
      { name: "John McDermott", r: 616, wp: 59, gw: 29, gp: 49 },
      { name: "Stuart Rogers", r: 543, wp: 43, gw: 3, gp: 7 },
      { name: "Sean McAllister", r: 471, wp: 29, gw: 2, gp: 7 },
      { name: "David Gardner", r: 469, wp: 39, gw: 19, gp: 49 },
    ] },
    ...
    { name: "Shooters", captain: "Adis Coralic", players: [
      { name: "Adis Coralic", r: 641, wp: 90, gw: 63, gp: 70, c: true },
      { name: "Omid Neshadi", r: 578, wp: 57, gw: 4, gp: 7 },
      { name: "Nasa Munkhnasan", r: 542, wp: 59, gw: 41, gp: 70 },
      { name: "Stephen Giddings", r: 514, wp: 46, gw: 26, gp: 56 },
    ] },

    { name: "Unbelief", captain: "Tony Habib / Kamal Melhem", players: [
      { name: "Tony Habib", r: 584, wp: 51, gw: 32, gp: 63, c: true },
      { name: "Kamal Melhem", r: 578, wp: 64, gw: 45, gp: 70, c: true },
      { name: "Kah Weng Tan", r: 575, wp: 48, gw: 13, gp: 27 },
      { name: "Phil Deschanel", r: 566, wp: 55, gw: 27, gp: 49 },
    ] },
  ...
  const divisionPlayers = [
    ...
    { name: "Joe Chao", r: 705, team: "Cue The Good Times", wp: 81, gw: 34, gp: 42 },
    { name: "Greg Jenkins", r: 698, team: "Break & Enter", wp: 64, gw: 27, gp: 42 },
    { name: "Chris Dam", r: 680, team: "Extorting Dogs", wp: 57, gw: 16, gp: 28 },
    { name: "John Tan", r: 669, team: "Gilas", wp: 52, gw: 22, gp: 42 },
    { name: "Shaun Oglesby", r: 667, team: "Marvin's Crew", wp: 70, gw: 44, gp: 63 },
    { name: "Adis Coralic", r: 641, team: "Shooters", wp: 90, gw: 63, gp: 70 },
    { name: "Adam Taylor", r: 627, team: "Extorting Dogs", wp: 64, gw: 18, gp: 28 },
    { name: "Sam Stacy", r: 627, team: "Extorting Dogs", wp: 57, gw: 32, gp: 56 },
    { name: "Raymart Pangan", r: 626, team: "Gilas" },
    { name: "Mitchell Tucker", r: 617, team: "Marvin's Crew", wp: 43, gw: 3, gp: 7 },
    { name: "John McDermott", r: 616, team: "Marvin's Crew", wp: 59, gw: 29, gp: 49 },
    ...
    { name: "Dinesh Sookgreep", r: 577, team: "Iron 4", wp: 52, gw: 33, gp: 63 },
    { name: "Dai Leota", r: 575, team: "Iron 4", wp: 65, gw: 41, gp: 63 },
    { name: "Kah Weng Tan", r: 575, team: "Unbelief", wp: 48, gw: 13, gp: 27 },
    { name: "Phil Deschanel", r: 566, team: "Unbelief", wp: 55, gw: 27, gp: 49 },
    { name: "Mark Harper", r: 559, team: "Freeballers", wp: 54, gw: 30, gp: 56 },
    { name: "Graz Ferreri", r: 558, team: "Iron 4", wp: 59, gw: 37, gp: 63 },
    { name: "Alfie Compuesto", r: 550, team: "Gilas", wp: 62, gw: 26, gp: 42 },
    ...
    { name: "Sean McAllister", r: 471, team: "Marvin's Crew", wp: 29, gw: 2, gp: 7 },
    { name: "David Gardner", r: 469, team: "Marvin's Crew", wp: 39, gw: 19, gp: 49 },
    { name: "Josh Leary", r: 465, team: "Freeballers", wp: 37, gw: 26, gp: 70 },
    { name: "Michael Eskander", r: 465, team: "Nice Rack", wp: 31, gw: 11, gp: 35 },
    { name: "Liam Pratt", r: 454, team: "Extorting Dogs", wp: 36, gw: 10, gp: 28 },
    { name: "Gerard Crowe", r: 445, team: "Freeballers", wp: 38, gw: 8, gp: 21 },
    { name: "Liam Anderson", r: 435, team: "Double Kiss", wp: 29, gw: 2, gp: 7 },
    { name: "Steven Tien", r: 434, team: "Dragonball Z", wp: 38, gw: 16, gp: 42 },
